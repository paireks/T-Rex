...
namespace T_Rex
{
    public class ProfileToElementsGH : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            ProfileToElements profileToElements = new ProfileToElements(profile, line, material, type);

            DA.SetData(0, profileToElements);
            DA.SetDataList(1, profileToElements.Breps);
            DA.SetDataList(2, profileToElements.Planes);
        }
